...
var TotalReservas = /*#__PURE__*/function () {
  function TotalReservas(reserva) {
...
var myBookings = function myBookings(reservas) {
  return reservas.map(function (reserva) {
    // Se utiliza map para iterar en el objeto
    var totalesCliente = new TotalReservas(reserva); // Se instancia la clase TotalesDepartamento, diciendole qué descuento tiene para que lo aplique al constructor
...
var TourOperador = /*#__PURE__*/function (_TotalReservas) {
  _inherits(TourOperador, _TotalReservas);

  var _super = _createSuper(TourOperador);

  // se declara la clase hija
  function TourOperador(reserva) {
    var _this;

    _classCallCheck(this, TourOperador);

    _this = _super.call(this, reserva); // se aplican los valores del constructor padre al hijo

    _this.discount = 0.15;
    return _this;
  }

  _createClass(TourOperador, [{
    key: "totalRoom",
    value: function totalRoom() {
...
var tour = function tour(reservas) {
  return reservas.map(function (reserva) {
    // Se utiliza map para iterar en el objeto
    var totalesCliente = new TourOperador(reserva); // Se instancia la clase TotalesDepartamento, diciendole qué descuento tiene para que lo aplique al constructor
...
//# sourceMappingURL=/LM-BJS-Module-11.e31bb0bc.js.map